...
# Obtendo os dados do Yahoo Finance para PETR4 no período de 2023-01-01 a 2023-12-31
dados = yf.download('PETR4.SA', start='2023-01-01', end='2023-12-31')

# Renomeando as colunas do DataFrame de dados
...
# Criando uma figura e um eixo para o gráfico com matplotlib
